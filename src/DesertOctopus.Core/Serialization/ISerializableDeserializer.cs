...
namespace DesertOctopus.Serialization
{
    ...
    internal static class ISerializableDeserializer
    {
                                                        ...
                                                        ParameterExpression newInstance)
        {
            ...
            var value = Expression.Parameter(dictionaryType.GetTypeInfo().GenericTypeArguments[1], "value");
            ...
            loopExpressions.Add(Expression.Call(newInstance, DictionaryMih.Add(dictionaryType, keyType, dictionaryType.GetTypeInfo().GenericTypeArguments[1]), key, value));
                                              ...
                                              ParameterExpression deserializer)
        {
            ...
            else if (expectedType.GetTypeInfo().IsPrimitive || expectedType.GetTypeInfo().IsValueType)
            {
