...
namespace DesertOctopus
{
    ...
    public static class ObjectCloner
    {
        ...
        public static T Clone<T>(T obj)
        {
            ...
            if (queryable != null)
            {
                var genericArgumentType = queryable.GetTypeInfo().GenericTypeArguments[0];
        ...
        private static Func<object, ObjectClonerReferenceTracker, object> GenerateCloner(Type sourceType)
        {
            ...
            if (sourceType.GetTypeInfo().IsPrimitive || sourceType.GetTypeInfo().IsValueType || (sourceType == typeof(string)))
            {
