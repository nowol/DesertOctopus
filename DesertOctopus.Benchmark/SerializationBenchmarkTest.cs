...
namespace DesertOctopus.Benchmark
{
    ...
    public class SerializationBenchMark
    {
        ...
        {
            product = ServiceStack.Text.JsonSerializer.DeserializeFromString<Product>(json);
            product.Description = null;
            product.DisplayName = null;
            product.ParentCategories = null;
            product.PropertyBag = null;
            product.Variants = null;
            //product.RelatedCategories = null;
            ...
            ServiceStack.Text.JsonSerializer.DeserializeFromString<Product>(json);
        }
