...
namespace DesertOctopus.Benchmark
{
    ...
    public class CloningBenchMark
    {
        ...
        public CloningBenchMark()
        {
            product = ServiceStack.Text.JsonSerializer.DeserializeFromString<Product>(SerializationBenchMark.JsonProduct);
